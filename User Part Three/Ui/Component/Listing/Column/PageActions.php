...
{
    /** Url path */
    const CMS_URL_PATH_EDIT = 'user2/page/edit';
    const CMS_URL_PATH_DELETE = 'user2/page/delete';
        ...
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as & $item) {
                ...
                if (isset($item['user_id'])) {
                    ...
                    $item[$name]['delete'] = [
                        'href' => $this->urlBuilder->getUrl(self::CMS_URL_PATH_DELETE, ['user_id' => $item['user_id']]),
                        'label' => __('Delete'),
                        'confirm' => [
