...
class PriceAllowAttribute implements DataPatchInterface
{
    /**
    ...
    public function apply()
    {
        ...
        $attribute = $customerSetup->getEavConfig()->getAttribute(Customer::ENTITY, 'price_allow');
        $attribute->setData(
            'used_in_forms',
