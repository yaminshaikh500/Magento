<?php
namespace Cp\Company\Setup\Patch\Data;
    ...
    public function apply()
    {
        ...
        $customerSetup->addAttribute(
            ...
            [
                ...
                'system' => 0,
                'position' => 999,
               // 'source' => 'Cp\Company\Model\Config\Source\CustomerType'
            ]
        );
        ...
        $attribute->setData(
            'used_in_forms',
            ['adminhtml_customer', 'customer_account_create', 'customer_account_edit', 'company_staff_create']
        );
        $attribute->save();
